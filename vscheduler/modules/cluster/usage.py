...
def mem(node):
    ...
    try:
        if node_os == 'Windows':
            ...
            stdout_query_copy_total_mem = std_print(stdin_query, stdout_query, stderr_query, "total")
            ...
            stdout_query_copy_avail_mem = std_print(stdin_query, stdout_query, stderr_query, "avail")
            ...
            print (stdout_query_copy[1][3], stdout_query_copy[1][1])
